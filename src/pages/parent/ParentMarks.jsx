...
export default function ParentMarks() {
  ...
  useEffect(() => {
    ...
    const fetch = async () => {
      ...
      setMarks(marksSnap.docs.map(d => ({ id: d.id, ...d.data(), exam: examMap[d.data().examId] }))
    ...
    <div className="app-layout">
      ...
      <main className="main-content animate-fade-up">
        <div className="page-header">
          <h1>Child's Marks</h1>
          <p>Subject-wise exam results for {userData?.linkedStudentName || "your child"}</p>
        </div>
            ...
            return (
              <div key={subject} style={{ marginBottom: 28 }}>
                ...
                <div className="table-wrapper">
                  <table>
                    <thead><tr><th>Exam</th><th>Date</th><th>Marks</th><th>Max</th><th>Percentage</th><th>Grade</th></tr></thead>
                    <tbody>
                      {subMarks.map(m => {
                        ...
                        return (
                          <tr key={m.id}>
                            ...
                            <td><span className={`badge ${pct >= 70 ? "badge-green" : pct >= 50 ? "badge-orange" : "badge-red"}`}>{grade}</span></td>
                          </tr>
                        );
                      })}
                    </tbody>
