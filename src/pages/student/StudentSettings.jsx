      ...
      <main className="main-content animate-fade-up">
        ...
        <div className="glass-card" style={{ maxWidth: 480 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
            <div style={{ width: 40, height: 40, borderRadius: "50%", background: "rgba(79,156,249,0.15)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--accent-blue)", fontSize: 18 }}>
              <FaKey />
            </div>
            <div>
        ...
        <div className="glass-card" style={{ maxWidth: 480, marginTop: 24 }}>
          ...
          <div style={{ fontSize: 14, color: "var(--text-secondary)" }}>
            ...
            <p style={{ marginTop: 8 }}><strong style={{ color: "var(--text-primary)" }}>Role:</strong> <span className="badge badge-blue">Student</span></p>
          </div>
        </div>
      </main>
    </div>
